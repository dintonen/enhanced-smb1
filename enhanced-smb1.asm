;ENHANCED SUPER MARIO BROS. - ASSEMBLY FILE
;(c) 2022 Dintonen Inc. / GamingWithEvets Inc.
;(c) 1985 Nintendo
...
Palette1_MTiles:
  ...
  .byte $75, $52, $76, $52 ;mushroom stump top
  .byte $52, $52, $52, $52 ;mushroom stump bottom
...
E_CastleArea6:
      ...
      .byte $4e, $65, $e1, $0f, $0e, $8e, $02, $e0, $0f, $10, $fe, $e5, $e1
...
L_GroundArea8:
      ...
      .byte $43, $43, $f8, $64, $0c, $be, $73, $40, $84, $40 ;railing fix
...
;level 5-1 (small castle fix)
L_GroundArea11:
      .byte $92, $b1
      .byte $0f, $20, $6e, $45, $0d, $02, $c8, $72, $1c, $81
...
WarpZoneObject:
      ...
      lda Player_Y_Position  ;check to see if player's vertical coordinate
      cmp #$00               ;is on page 0, if not don't scroll the screen
      bne ExGTimer           ;if so, branch to leave
      sta ScrollLock         ;otherwise nullify scroll lock flag
      nop                    ;minus world bug fix
	  nop                    ;(by Mike Schiraldi, covered by Displaced Gamers)
...
UpToFiery:
       ldy #$01         ;set value to be used as new player state
